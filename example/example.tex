...
% 但 \makeatletter 这几个命令必需在行首，前面可以有空格
...
\texhighverb[enhanced=false, char-replacements={a=A, b=B, {=}={,}}]{abcd=$}
\end{examcode}
