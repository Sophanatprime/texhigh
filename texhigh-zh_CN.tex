...
如果在 \pkg{texhigh} 加载之前已经加载了 \pkg{tikz} 宏包，或启用了 \texttt{tikz} 宏包选项，
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{listing engine}
  \begin{syntax}
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{texhigh options,texhigh options pre,texhigh options app}
  \begin{syntax}
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{texhigh gobble}
  \begin{syntax}
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{texhigh style}
  \begin{syntax}
    texhigh style = <{style}>
  \end{syntax}
...
\begin{keyval}[module=tcolorbox, path=/tcolorbox]{texhigh detect catcode}
  \begin{syntax}
